...
const PlayCard = ({play}) => {
  return (
    ...
    <div className='bg-black w-[90%] mx-auto p-0.5 rounded-lg'>
      ...
      <Image  variant={"rounded"} url={"https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Douglas_Fairbanks_Robin_Hood_1922_film_poster.jpg/220px-Douglas_Fairbanks_Robin_Hood_1922_film_poster.jpg"} alt={"imagen obra"} />

      <div id='body-card' className='px-3 py-1 space-y-2 text-base' >

        <Title type={"H2"} variant={"white"} text={play.titulo} />
        <Title type={"H3"} variant={"orange"} text={play.asociacion} />
